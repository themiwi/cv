...
\begin{list2}
  ...
  \item Beteiligt an der Anwendung von Machine Learning und statistischer
    Analyse für die Betriebsoptimierung von Wasserkraftanlagen und
    vorausschauender Wartung.

  \item Verbindung zwischen den Entwicklungsabteilungen und dem
    Datenanalyseteam. Einbringung des notwendigen Domänenwissens,
    Entwicklung von Prototyp-Algorithmen.
...
\begin{list2}
  \item Die Infrastruktur des Instituts für Fluid Dynamik umfasste einen
    kleinen Rechencluster, einen NFS4 Dateiserver mit
    Kerberos-Authentifizierung, einen Mail- und Webserver, ungefähr fünfzig
    Workstations und drei{\ss}ig Rechner im Studentenraum.
\end{list2}

\textbf{RUAG Aerospace}, Emmen \vspace{2mm}\\\vspace{1mm}%
\textsl{Praktikum} \hfill \textbf{Juni -- Oktober, 2004}\\
\begin{list2}
  \item Entwickler eines MATLAB-Werkzuegs zur Leistungsschätzung des
    Automobilwindkanals.
\end{list2}
...
\begin{list2}
  \item Programmierer eines Simulationsprogramms in MATLAB für die Ausbreitung
    von durch Erwärmung mittels Laser ausgelösten Schallwellen. Dieses wurde
    zur Entwicklung einer neuen Methode zur Schichtdickenmessung von Chipwavern
    verwendet.
\end{list2}

\section{\mysidestyle Projektleitung}\vspace{6mm}
\begin{list2}
  \item Fünf Jahre Erfahrung als Scrum Master in mehreren Projekten mit
